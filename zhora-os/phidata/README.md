...
**Phidata is a framework for building Autonomous Assistants** (aka Agents) which have long-term memory, contextual knowledge and the ability to take actions using function calling.
